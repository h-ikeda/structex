defmodule Structex do
  ...
  identifier.
      ...
      ...>   },
      ...>   {
      ...>     [[Tensorex.from_list([[ 3.2, 0], [0,  6.0]]), Tensorex.from_list([[ -3.2, 0], [0,  -6.0]])], [Tensorex.from_list([[ -3.2, 0], [0,  -6.0]]), Tensorex.from_list([[ 3.2, 0], [0,  6.0]])]],
      ...>     [5, 6]
      ...>   },
      ...>   {
      ...>     [[Tensorex.from_list([[63.1, 0], [0, 55.3]])]],
                                           ...
                                           [5, 1] => -42.1,                                                [5, 5] =>  97.4,
                                                            [6, 2] =>  -5,                                                  [6, 6] =>  5,
                                                                           [7, 3] =>  -8,                                                 [7, 7] =>  8,
                                                                                                                                                        [ 8, 8] =>  3.9,                  [ 8, 10] => -3.9,
                                                                                                                                                                         [ 9, 9] =>  6.5,                   [ 9, 11] => -6.5,
                                                                                                                                                        [10, 8] => -3.9,                  [10, 10] =>  7.1,                   [10, 12] => -3.2,
                                                                                                                                                                         [11, 9] => -6.5,                   [11, 11] => 12.5,                   [11, 13] => -6.0,
                                                                                                                                                                                          [12, 10] => -3.2,                   [12, 12] =>  3.2,
                                                                                                                                                                                                            [13, 11] => -6.0,                   [13, 13] =>  6.0}, shape: [14, 14]},
        %{0 => 4..5, 1 => 0..1, 2 => 2..3, 3 => 6..7, 4 => 8..9, 5 => 10..11, 6 => 12..13}
      }
  """
